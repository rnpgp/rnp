...
image:https://github.com/rnpgp/rnp/workflows/macos/badge.svg["Build Status", link="https://github.com/rnpgp/rnp/actions?workflow=macos"]
image:https://github.com/rnpgp/rnp/workflows/centos7/badge.svg["Build Status", link="https://github.com/rnpgp/rnp/actions?workflow=centos7"]
