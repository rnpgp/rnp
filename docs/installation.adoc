...
sudo apt install g++-8 cmake libbz2-dev zlib1g-dev build-essential python-minimal
...
# Install required packages
sudo apt install g++-8 cmake libbz2-dev zlib1g-dev \
...
# Install packages
pacman --noconfirm -S --needed tar zlib-devel libbz2-devel git automake autoconf libtool automake-wrapper make pkg-config mingw64/mingw-w64-x86_64-cmake mingw64/mingw-w64-x86_64-gcc mingw64/mingw-w64-x86_64-libbotan mingw64/mingw-w64-x86_64-python3
----
...
[source,console]
----
vcpkg install --triplet x64-windows bzip2 zlib botan getopt dirent python3[core,enable-shared]
----
...
* BZip2 (optional, may be disabled with `-DENABLE_BZIP2=Off`)
* GetOpt
* ZLIB
