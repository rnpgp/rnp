...
| `x86_64-apple-darwin`       | botan, openssl | `macos-13`          | Intel; `MACOSX_DEPLOYMENT_TARGET=11.0`
| `aarch64-apple-darwin`      | botan, openssl | `macos-14`          | Apple Silicon; `MACOSX_DEPLOYMENT_TARGET=12.0`
| `x86_64-pc-windows-msvc`    | botan, openssl | `windows-latest`    | MSVC 2022, `/MT` static runtime, via vcpkg
|===

14 tarballs per release (7 target triples × 2 backends).
